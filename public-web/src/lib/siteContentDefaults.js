...
export const DEFAULT_SITE_CONTENT = {
  ...
  hero: {
    ...
    stat3: '24/7 дэмжлэг',
    badge: 'Gennetex ХХК',
    // Нүүрний баннерын дэвсгэр видео. Хоосон бол видеогүй зурагдана.
    videoUrl:
    ...
    videoPoster: '',
    // Гарчгийн мөрүүд. Эхнийх нь бараан, үлдсэн нь зөөлөн саарал.
    // `lead4` дотор `|` тэмдэг байвал тэр байрлалд дугуй "нүд" элемент орно.
    lead1: 'Gennetex —',
    lead2: 'сүлжээ, шилэн кабель,',
    lead3: 'хяналтын систем ба IT дэд бүтцийн',
    lead4: 'иж бүрэн | шийдэл.',
    searchPlaceholder: 'Юу хайж байна?',
    year: '2026',
    cornerNote: 'сүлжээний дэд бүтэц',
  ...
  careers: {
    ...
    intro:
      'Gennetex ХХК-ийн албан ёсны ажилд орох анкетыг доор бөглөн илгээнэ үү. Бөглөсөн мэдээлэл шууд хүний нөөцийн багт очно.',
    pageIntro: 'Gennetex ХХК-ийн албан ёсны анкетыг бөглөнө үү. Бүх талбарыг үнэн зөв бөглөнө.',
    perksTitle: 'Мэдээлэл',
    perks: [
    ...
    openingsNote: 'Сонирхсон байрандаа доорх анкетыг бөглөнө үү.',
