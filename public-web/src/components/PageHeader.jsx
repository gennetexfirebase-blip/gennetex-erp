export default function PageHeader({ label, title, description }) {
  return (
    <div className="public-page-header border-b border-graphite-800 bg-gradient-to-b from-graphite-900/80 to-transparent px-4 py-16 sm:px-6 md:px-12 md:py-20">
