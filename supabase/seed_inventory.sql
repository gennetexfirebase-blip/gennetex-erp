-- ============================================================
-- Gennetex ERP — Бараа материал & Багаж (inventory seed)
-- ============================================================
-- Эхлээд category багана байгаа эсэхийг баталгаажуулна:
...
-- ---------- Багаж (category = 'tool') ----------
insert into public.inventory (name, unit, quantity, price, barcode, category) values
  ('Кримп хавчаар (RJ45)', 'ширхэг', 15, 45000, '4820000000116', 'tool'),
  ...
  ('Шураг эргүүлэгч багц', 'багц', 12, 55000, '4820000000185', 'tool'),
  ('Цахилгаан өрөм', 'ширхэг', 5, 180000, '4820000000192', 'tool'),
  ('Шат (2м)', 'ширхэг', 6, 120000, '4820000000208', 'tool')
on conflict do nothing;

-- Шалгах:
-- select category, count(*) from public.inventory group by category;
