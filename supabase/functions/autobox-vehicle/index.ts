...
Deno.serve(async (req) => {
  ...
  try {
    ...
    /**
     * ⚠️ ДУГААРЫН ДОТООД ЗАЙГ ЗААВАЛ АРИЛГАНА.
     *
     *    autobox.mn нь `7534УНЧ` дээр 12 торгууль буцаадаг мөртлөө
     *    `7534 УНЧ` (зайтай) дээр ЗӨВХӨН 1 буцаадаг — алдаа заахгүй,
     *    зүгээр л дутуу. Гаднаас харахад "энэ машин цэвэр байна" гэж
     *    ойлгогдох тул хамгийн аюултай төрлийн алдаа.
     *
     *    Манай `vehicles.plate_number` нь дугаарыг ЗАЙТАЙ хадгалдаг
     *    ("7534 УНЧ"). Апп тал `plateToAutoboxQuery`-ээр цэвэрлэдэг ч
     *    энэ функцийг өөр газраас (admin-web, cron, гараар туршилт)
     *    шууд дуудвал дутуу өгөгдөл чимээгүй буцна.
     *
     *    Тиймээс сервер тал дээрээ ч давхар хамгаална.
     */
