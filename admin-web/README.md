...
- 📈 Ажилчдын гүйцэтгэл — нийт хэдэн баг, өдөрт хэдэн айл, нийт хэр хугацаанд, 1 баг өдөрт хэдэн айл. Өдөр/сар/жилээр шүүх, график, Excel-ийг ГРАФИКТАЙ нь татах, буцааж импортлох (мобайл апп дээр мөн адил)
